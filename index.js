...
var nome= prompt('Digite seu nome e receba uma mensagem para o seu dia !');
var data_atual = new Date();
var numero_escolhido = data_atual.getDate();

console.log(alert("A data de hoje é : " + numero_escolhido +', temos uma mensagem para o dia de hoje!'));
numero_escolhido--;

var frase_do_dia = frases_do_dia[numero_escolhido];

console.log(alert("Frase do dia !"));
console.log(alert(` ${nome}, a frase do dia é a seguinte :  ` +' ' + frase_do_dia + '!'));
console.log(alert('Volte amanhã e tenha outra mensagem do dia ! :D'));